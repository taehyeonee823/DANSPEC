...
## 📢 유의 사항
* **기기 최적화**: 본 프로젝트는 **iOS 환경**을 기준으로 UI/UX가 최적화되어 있으므로 가급적 **iPhone(iOS)** 기기에서 **Expo Go** 앱으로 확인하시는 것을 권장합니다
* **프로젝트 용도**: 본 프로젝트는 대회 출품 및 기술적 검증을 위한 포트폴리오 용도로 제작되었습니다
* **데이터 출처**: [캠퍼스픽](https://www.campuspick.com/), 영웅스토리 (단국대학교)
* **저작권 안내**: 수집된 데이터를 상업적으로 활용하지 않으며, 모든 저작권은 원천 데이터 제공처에 있습니다
* **협업 정보**: 본 서비스는 백엔드 개발자 및 기획자와의 협업으로 제작된 팀 프로젝트입니다
